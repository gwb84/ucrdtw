...
if __name__ == '__main__':
    ...
    parser.add_argument('curr_ind', metavar='CURR_IND', type=int, default=-1, help='Current index for self similarity')
    parser.add_argument('ez', metavar='EZ', type=int, default=2, help='Exclusion Zone for self similarity')
    ...
    print(_ucrdtw.ucrdtw(data, query, args.warp_width, args.curr_ind, args.ez, True))
